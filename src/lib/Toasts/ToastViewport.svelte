<script lang="ts">
    ...
    let { state: toastState = getToastState() }: { state?: ToastState } =
        $props();
    ...
    const toneTheme = {
        success: {
            ...
            secondaryAction:
                "text-teal-700 hover:text-teal-800 focus-visible:ring-teal-200",
            primaryAction:
        ...
        error: {
            ...
            secondaryAction:
                "text-rose-500 hover:text-rose-600 focus-visible:ring-rose-200",
            primaryAction:
    ...
    $effect(() => {
        const hasTimedToast = toastState.toasts.some(
            (toast) => toast.durationMs !== null,
        );
...
<div
    class="pointer-events-none fixed inset-x-0 bottom-4 z-[70] flex justify-center px-4 sm:justify-end sm:px-6 lg:bottom-6 lg:px-8"
>
            ...
            >
                {#if isCompact}
                    <div class="flex items-center gap-4 px-6 py-7">
                        ...
                        <h2
                            class="min-w-0 flex-1 text-[1.15rem] font-semibold leading-none tracking-[-0.02em] text-stone-950 sm:text-[1.2rem]"
                        >
                            {toast.title}
                        </h2>
                    ...
                    <div class="px-6 pb-6 pt-5">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                >
                                    <h2
                                        class="pr-3 text-[1.25rem] font-semibold leading-[1.2] tracking-[-0.02em] text-stone-950"
                                    >
                                        {toast.title}
                                    </h2>
                                ...
                                <p
                                    class="mt-5 max-w-[42ch] text-[1rem] leading-[1.35] text-stone-800 sm:text-[1.05rem]"
                                >
                                    {toast.description}
                                </p>
