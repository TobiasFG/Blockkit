        ...
        >
            ...
            {#if !collapsed}
                ...
                {#if depth === 0 && publishState === "published"}
                    <span
                        class="shrink-0 rounded-full bg-emerald-50 px-2.5 py-1 text-[11px] font-medium text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300"
                    >
                        Published
                    </span>
                {:else if hasChildren}
                ...
                {:else}
                    <span
                        class={`h-2.5 w-2.5 shrink-0 rounded-full ${publishStateClass}`}
                    ></span>
                {/if}
                <Button
                    type="button"
