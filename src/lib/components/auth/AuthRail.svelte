...
>
    <div class="flex items-center gap-3">
        <div
            class="grid h-11 w-11 place-items-center rounded-md bg-primary text-sm font-semibold text-primary-foreground"
        >
            BK
        </div>
        <div>
            <p
                class="text-[11px] font-semibold tracking-[0.32em] text-muted-foreground"
            >
                Preview
            </p>
            <h1 class="font-serif text-2xl tracking-tight">BlockKit</h1>
        </div>
    </div>
    ...
    <div
        class="mt-4 flex items-center justify-between gap-3 border-t border-border/60 pt-4 text-sm text-muted-foreground"
    >
