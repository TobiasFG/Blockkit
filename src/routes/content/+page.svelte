...
<main class="space-y-8">
    ...
    >
        <div
            class="absolute inset-y-0 right-0 hidden w-1/3 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.18),transparent_70%)] lg:block"
        ></div>
        <div class="relative grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
            <div class="space-y-4">
                <p
                    class="text-xs font-semibold uppercase tracking-[0.35em] text-white/70"
                >
                    Content
                </p>
                <h1
                    class="max-w-3xl text-4xl font-black tracking-tight text-white sm:text-5xl"
                >
                    Create shared content here. Edit it elsewhere. Keep the CMS
                    tree clean.
                </h1>
                <p
                    class="max-w-2xl text-base leading-7 text-white/80 sm:text-lg"
                >
                    This is dedicated surface for folders and content items.
                    Sidebar stays focused on navigation while this page handles
                    creation, organization, and direct links into the editor.
                </p>
            </div>
            ...
            <div class="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                ...
                >
                    ...
                    <div class="mt-2 text-3xl font-black text-white">
                        {currentBlockDefinitions.length}
                    </div>
                </div>
            </div>
        </div>
